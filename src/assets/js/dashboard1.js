...
$(function() {
    ...
    new Chartist.Line('#sales-overview', {
        ...
        series: [
            { meta: "Earning ($)", data: [0, 150, 110, 240, 200, 200, 300, 200, 380, 300, 400, 380] }, { meta: "Expense ($)", data: [0, 100, 70, 100, 240, 180, 220, 140, 250, 210, 340, 320] }, { meta: "Sales", data: [0, 50, 30, 60, 180, 120, 180, 80, 190, 150, 240, 240] }
        ]
    }, {
        low: 0,
        high: 400,
